<!-- @canonical: canon@ded52144:domains/compute/exynos/exynos.md -->
<!-- @extracted: 2026-05-10 -->
<!-- @md5_at_extraction: 7e4d8226a9d2c44f7b1f71c3171e0c1f -->
...
# Ultimate Exynos SoC (HEXA-EXYNOS)

## §1 WHY (how this technology changes your life)

The n=6 mobile SoC CPU-GPU-NPU integration is the product of decades of accumulated trade-offs — every core a different pitch, every rail a different voltage, every protocol a different header.
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│  [AI TOPS (INT8)] current vs HEXA comparison
│------------------------------------------------------------------------
│  Exynos 2400             ███░░░░░░░░░░░░░░░░░░░░░░░░░░░░░  34
│  Snapdragon 8 Gen3       ████░░░░░░░░░░░░░░░░░░░░░░░░░░░░  45
│  Apple A17 Pro           ████░░░░░░░░░░░░░░░░░░░░░░░░░░░░  35
│  Dimensity 9300          ████░░░░░░░░░░░░░░░░░░░░░░░░░░░░  48
│  HEXA-EXYNOS             ████████████████████████████████  288 (σ·J₂=288 scale)
│
...
|-------------|---------|---------|------|-----------|------|
| chip-architecture | 🛸7 | 🛸10 | +3 | SoC fabric | [doc](../chip-architecture/chip-architecture.md) |
| ai-efficiency | 🛸7 | 🛸10 | +3 | AI block | [doc](../ai-efficiency/ai-efficiency.md) |
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│                     Ultimate Exynos SoC (HEXA-EXYNOS) system architecture                                   │
├────────────┬────────────┬────────────┬────────────┬─────────────────────┤
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│  Ultimate Exynos SoC (HEXA-EXYNOS) Technical Specifications                                         │
├──────────────────────────────────────────────────────────────────────────┤
│  category         soc                                             │
...
A stdlib-only honesty check that Ultimate Exynos SoC (HEXA-EXYNOS) holds up physically and mathematically — each claimed design spec is cross-checked against first-principles formulas.

### Testable Predictions (10)

#### TP-EXYNOS-1: MAC array = σ·J₂ = 288
...
#!/usr/bin/env python3
# ─────────────────────────────────────────────────────────────────────────────
# §7 VERIFY — Ultimate Exynos SoC (HEXA-EXYNOS) n=6 honesty check (stdlib only, soc domain)
#
...
Realization roadmap for Ultimate Exynos SoC (HEXA-EXYNOS) — each Mk stage requires specific process and software maturity:
...
§7 10 sub-section honesty check passes. `exynos` document canonical v2 drafted.
