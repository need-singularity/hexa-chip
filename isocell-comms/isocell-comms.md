<!-- @canonical: canon@ded52144:domains/compute/isocell-comms/isocell-comms.md -->
<!-- @extracted: 2026-05-10 -->
<!-- @md5_at_extraction: edeab9b9d1b22e0f2e64b15976f6b355 -->
...
# Ultimate ISOCELL communications (HEXA-ISOCELL)

## §1 WHY (how this technology changes your life)

The n=6 CMOS image sensor plus on-chip communications stack is the product of decades of accumulated trade-offs — every core a different pitch, every rail a different voltage, every protocol a different header.
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│  [pixel readout (Gpix/s)] current vs HEXA comparison
│------------------------------------------------------------------------
│  IMX989                  ██░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░  1.5
│  ISOCELL HP2             ███░░░░░░░░░░░░░░░░░░░░░░░░░░░░░  3.0
│  LYT900                  ███░░░░░░░░░░░░░░░░░░░░░░░░░░░░░  3.5
│  ISOCELL HP9             █████░░░░░░░░░░░░░░░░░░░░░░░░░░░  5.0
│  HEXA-ISOCELL            ████████████████████████████████  28.8 (σ·J₂=288 scale)
│
...
|-------------|---------|---------|------|-----------|------|
| chip-photonic | 🛸7 | 🛸10 | +3 | photonic front-end | [doc](../chip-photonic/chip-photonic.md) |
| chip-architecture | 🛸7 | 🛸10 | +3 | ISP host | [doc](../chip-architecture/chip-architecture.md) |
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│                     Ultimate ISOCELL communications (HEXA-ISOCELL) system architecture                                   │
├────────────┬────────────┬────────────┬────────────┬─────────────────────┤
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│  Ultimate ISOCELL communications (HEXA-ISOCELL) Technical Specifications                                         │
├──────────────────────────────────────────────────────────────────────────┤
│  category         image-sensor-comms                              │
...
A stdlib-only honesty check that Ultimate ISOCELL communications (HEXA-ISOCELL) holds up physically and mathematically — each claimed design spec is cross-checked against first-principles formulas.

### Testable Predictions (10)

#### TP-ISOCELL-COMMS-1: MAC array = σ·J₂ = 288
...
#!/usr/bin/env python3
# ─────────────────────────────────────────────────────────────────────────────
# §7 VERIFY — Ultimate ISOCELL communications (HEXA-ISOCELL) n=6 honesty check (stdlib only, image-sensor-comms domain)
#
...
Realization roadmap for Ultimate ISOCELL communications (HEXA-ISOCELL) — each Mk stage requires specific process and software maturity:
...
§7 10 sub-section honesty check passes. `isocell-comms` document canonical v2 drafted.
